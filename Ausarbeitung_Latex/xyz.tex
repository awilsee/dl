...
\section{Introduction}
	\subsection{Deep learning and Machine learning}
...
\section{Realisation}
	\subsection{Installation of the software components}
 		- software environment
			\subsection{Tensorflow based on Python}
			\subsection{Tensorflow based on Bazel}
				- e.g. Workspace changes for Android SDK
			\subsection{Installing Android Studio and its Delevopment Kit}
				- SDK, NDK

	\subsection{Retraining the pre-trained Models}
		- Mobilnet
		- Inception
...
\section{Evaluation} - prio von nierdig zu hoch
